...
public class Forklift extends ExpeditiousSubsystem {
	...
	public void extendForklift()
	{
		...
		System.out.println("Pistons are out"); //I believe these values should be the same, we want the soleoids to be in synch Dom
	}
	...
	public void retractForklift()
	{
		airInSol.set(!RobotMap.FORKLIFT_SOLENOID_VALUE);
        airOutSol.set(RobotMap.FORKLIFT_SOLENOID_VALUE);
        System.out.println("Pistons are in");//I believe these values should be the same, we want the soleoids to be in synch Dom
	}
